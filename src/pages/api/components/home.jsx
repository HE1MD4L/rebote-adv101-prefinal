...
import "./home.css"; // <-- import new stylesheet
...
export default function Home() {
  ...
  function toggleComplete(id) {
    ...
    setTodos((s) =>
      s.map((it) =>
        it.id === id ? { ...it, completed: !it.completed, updatedAt: now } : it
      )
    );
  }
  ...
  function saveEdit(e) {
    ...
    setTodos((s) =>
      s.map((it) =>
        it.id === editingId
          ? { ...it, title: t, description: editingDescription.trim(), updatedAt: now }
          : it
      )
    );
    setEditingId(null);
  ...
  return (
    <div className="page">
      <header className="header">
        ...
        <nav className="nav">
          <button className={`nav-btn ${tab === "todo" ? "active" : ""}`} onClick={() => setTab("todo")}>
            To Do
          </button>
          <button className={`nav-btn ${tab === "completed" ? "active" : ""}`} onClick={() => setTab("completed")}>
            Completed
          </button>
        </nav>
                    ...
                    {editingId === it.id ? (
                      <form onSubmit={saveEdit} className="edit">
                        ...
                        <div className="card-actions">
                          ...
                          <button className="ghost small" type="button" onClick={() => setEditingId(null)}>
                            Cancel
                          </button>
                        </div>
                      </form>
